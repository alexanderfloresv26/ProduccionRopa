...
public class ArchivoRandomLote {
    ...
    private void escribirLote(Lote lote) throws IOException {
        ...
        archivo.writeUTF(
                lote.getFechaFabricacion().toString());

        archivo.writeUTF(
                String.format("%-30s",
                        lote.getPrenda().getModelo()));
    }
        ...
        try {
            ...
            while (archivo.getFilePointer()
                ...
                if (!eliminado &&
                    ...
                    ArchivoRandomPrenda arp =
                            new ArchivoRandomPrenda(
                                    "prendas.dat");
